  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="prose prose-gray dark:prose-invert max-w-none">
        ...
        <p>
          <strong>We never use any of your Personal Information.</strong>
        </p>

        <h2 className="text-hackergreen">Information Collection and Use</h2>
        
        <p>
          The site does not use any third party services that may collect information used to identify you.
        </p>
        ...
        <ul>
          <li className="text-hackergreen">To facilitate our Service;</li>
          <li className="text-hackergreen">To provide the Service on our behalf;</li>
          <li className="text-hackergreen">To perform Service-related services; or</li>
          <li className="text-hackergreen">To assist us in analyzing how our Service is used.</li>
        </ul>
        ...
        <h2 className="text-hackergreen">Security</h2>
        
        <p>
          I value your trust in providing us your Personal Information, thus we are striving to use commercially acceptable means of protecting it. But remember that no method of transmission over the internet, or method of electronic storage is 100% secure and reliable, and I cannot guarantee its absolute security.
        </p>

        <h2 className="text-hackergreen">Links to Other Sites</h2>
        ...
        <h2 className="text-hackergreen">Changes to This Privacy Policy</h2>
        
        <p>
          I may update our Privacy Policy from time to time. Thus, you are advised to review this page periodically for any changes. I will notify you of any changes by posting the new Privacy Policy on this page. These changes are effective immediately after they are posted on this page.
        </p>

        <h2 className="text-hackergreen">Contact Us</h2>
        
        <p>
          If you have any questions or suggestions about my Privacy Policy, do not hesitate to contact us, at{' '}
          <a href="mailto:fvrtrp@gmail.com" className="text-blue-600 hover:underline">
            fvrtrp@gmail.com
          </a>
        </p>

        <footer className="mt-12 text-sm text-gray-500">
          ©{new Date().getFullYear()} FVRTRP
        </footer>
      </div>
    </div>
  )
