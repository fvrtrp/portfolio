...
_Themes:_ Vanilla (which is essentially barebones sesh from 0.2), ninja, film reel (a new theme which loads a random movie poster from a curated list, and has a fancy animation when you hover on the poster, zen (a new theme which loads soothing colours and animations)
